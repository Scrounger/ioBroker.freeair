...
export var FreeAirDevice;
(function (FreeAirDevice) {
    let keys = undefined;
    function get() {
        return {
            airDensity: {
    ...
    FreeAirDevice.getKeys = getKeys;
    function getStateIDs() {
        return myHelper.getAllIdsOfTreeDefinition(get());
    }
    FreeAirDevice.getStateIDs = getStateIDs;
})(FreeAirDevice || (FreeAirDevice = {}));
